...
public class TouchableLinearLayout extends LinearLayout
{
    ...
    private void init(AttributeSet attrs)
    {
        ...
        if(attrs != null)
        {
            TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.TouchableLinearLayout);

            try
            {
                this.touchedDrawable = ta.getDrawable(R.styleable.TouchableLinearLayout_touched_drawable);
                this.borderDrawable = ta.getDrawable(R.styleable.TouchableLinearLayout_border_drawable);
            }
            catch(Throwable t)
            {
                t.printStackTrace();
