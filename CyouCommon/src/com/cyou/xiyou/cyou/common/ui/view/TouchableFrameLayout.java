...
public class TouchableFrameLayout extends FrameLayout
{
    ...
    private void init(AttributeSet attrs)
    {
        ...
        if(attrs != null)
        {
            TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.TouchableFrameLayout);

            try
            {
                this.touchedDrawable = ta.getDrawable(R.styleable.TouchableFrameLayout_touched_drawable);
                this.borderDrawable = ta.getDrawable(R.styleable.TouchableFrameLayout_border_drawable);
            }
            catch(Throwable t)
            {
                t.printStackTrace();
